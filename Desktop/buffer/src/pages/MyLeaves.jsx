...
export default function MyLeaves() {
    ...
    const leaves = [
        { id: 1, type: "Annual Leave", status: "APPROVED", statusColor: "text-green-600", statusBg: "bg-green-100", startDate: "Aug 15, 2025", endDate: "Aug 20, 2025", duration: "5 days", reason: "Summer vacation trip", submitted: "Jun 12, 2025", approvedBy: "Sarah H." },
        { id: 2, type: "Sick Leave", status: "PENDING", statusColor: "text-yellow-600", statusBg: "bg-yellow-100", startDate: "Sep 2, 2025", endDate: "Sep 2, 2025", duration: "1 day", reason: "Dental appointment", submitted: "Aug 28, 2025", approvedBy: null },
        { id: 3, type: "Personal Leave", status: "REJECTED", statusColor: "text-red-600", statusBg: "bg-red-100", startDate: "Jul 10, 2025", endDate: "Jul 12, 2025", duration: "3 days", reason: "Family event", submitted: "Jul 1, 2025", approvedBy: "Sarah H.", rejectReason: "Blackout period" },
        { id: 4, type: "Annual Leave", status: "APPROVED", statusColor: "text-green-600", statusBg: "bg-green-100", startDate: "Mar 20, 2025", endDate: "Mar 22, 2025", duration: "3 days", reason: "Public holiday extension", submitted: "Mar 10, 2025", approvedBy: "Sarah H." },
        { id: 5, type: "Maternity Leave", status: "PENDING", statusColor: "text-yellow-600", statusBg: "bg-yellow-100", startDate: "Oct 1, 2025", endDate: "Dec 31, 2025", duration: "65 days", reason: "Maternity leave", submitted: "Sep 1, 2025", approvedBy: null, hasDoc: true },
    ];
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="bg-[#f9f9ff] border-b border-[#c1c7d2] sticky top-0 z-20 px-4 sm:px-6 py-3 pt-16 sm:pt-3">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div>
                            <h2 className="text-lg font-semibold text-[#1a1c20]">My Leaves</h2>
                            <p className="text-xs text-[#414751]">Track all your leave submissions and their status</p>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                <Bell className="w-5 h-5 text-[#414751]" />
                                <span className="absolute -top-1 -right-1 w-3 h-3 bg-[#ba1a1a] rounded-full text-[8px] text-white flex items-center justify-center">3</span>
                            </div>
                ...
                <div className="p-6 max-w-5xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {filteredLeaves.map((leave) => (
                            <div key={leave.id} className="bg-white rounded-xl border border-[#c1c7d2] p-4 hover:shadow-md transition">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {leave.status === "PENDING" && (
                                            <>
                                                <button className="text-[#005597] hover:text-[#296eb4] text-sm flex items-center gap-1">
                                ...
                                <div className="text-xs text-[#414751] mt-2 pt-2 border-t border-[#c1c7d2]">
